...
if(git_update_strategy STREQUAL "CHECKOUT")
  ...
  if(error_code)
    ...
    if(NOT git_update_strategy STREQUAL "REBASE_CHECKOUT")
      ...
      message(FATAL_ERROR "\nFailed to rebase in: '/home/gerald/systems/Edusat-RPI-Dev/rpi_edu_system/Squareline_build_files/SquareLine_Project/build/_deps/lv_drivers-src'."
...
if(need_stash)
  ...
  if(error_code)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to unstash changes in: '/home/gerald/systems/Edusat-RPI-Dev/rpi_edu_system/Squareline_build_files/SquareLine_Project/build/_deps/lv_drivers-src'."
                          "\nYou will have to resolve the conflicts manually")
    endif()
  endif()
endif()
